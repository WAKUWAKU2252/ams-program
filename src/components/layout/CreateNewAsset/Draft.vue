      ...
      <div class="flex items-center gap-3">
        ...
        <div class="relative">
          <input
            ...
            class="w-full rounded-[16px] border px-3 py-2 pr-10 border-gray-300 focus:border-[var(--primary-color)] focus:outline-none"
          />
        ...
        <button
          type="button"
          class="whitespace-nowrap rounded-[16px] bg-[var(--primary-color)] px-4 py-2 text-white hover:opacity-90"
          @click="onCreate"
        >
          <i class="fa-solid fa-plus mr-2" />Create
        </button>
      </div>
    </div>
