  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: false, title: "Create New Asset" },
        children: [
          {
            path: "",
            name: "DraftList",
      ...
      },
      {
        ...
        meta: { requiresAuth: false, title: "Asset Request" },
      },
      {
        path: "asset-movements",
        name: "asset-movements",
        component: () => import("@/views/AssetMovements.vue"),
        meta: { requiresAuth: false, title: "Asset Movements" },
      },
      {
        path: "audit",
        name: "audit",
        component: () => import("@/views/audit.vue"),
        meta: { requiresAuth: false, title: "Audit" },
      },
      {
        path: "my-assets",
        name: "my-assets",
        component: () => import("@/views/MyAssets.vue"),
        meta: { requiresAuth: false, title: "My Assets" },
      },
